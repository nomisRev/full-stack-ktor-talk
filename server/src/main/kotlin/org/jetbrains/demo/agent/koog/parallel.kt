...
fun <IncomingInput, OutgoingInput, Output> parallel(
    input: AIAgentNodeBase<IncomingInput, List<OutgoingInput>>,
    node: AIAgentNodeBase<OutgoingInput, Output>,
    inputType: KType,
    outputType: KType,
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
    name: String? = null,
): AIAgentNodeDelegate<IncomingInput, List<Output>> =
    parallel(
        { it as List<OutgoingInput> },
        input as AIAgentNodeBase<IncomingInput, OutgoingInput>,
        node,
        inputType,
        outputType,
        dispatcher
...
inline fun <reified IncomingInput, OutgoingInput, reified Output> parallel(
    input: AIAgentNodeBase<IncomingInput, List<OutgoingInput>>,
    node: AIAgentNodeBase<OutgoingInput, Output>,
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): AIAgentNodeDelegate<IncomingInput, List<Output>> = parallel(
    input,
    node,
    typeOf<IncomingInput>(),
    typeOf<Output>(),
